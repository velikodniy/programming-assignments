...
\newcommand{\PubType}{Учебное пособие}            % Тип пособия
\newcommand{\EdType}{Учебно-практическое издание} % Тип издания
\newcommand{\Year}{2017}
...
\newcommand{\PUBORDER}{015}                                    % Номер заказа
\newcommand{\PUBCOUNT}{10}                                     % Тираж
\newcommand{\SHEETS}{5,0}                                      % Усл.-печ. листов (TODO: вычислять)
\newcommand{\CITY}{Бендеры}                                    % Город
...
\usepackage{calc}
\usepackage{lastpage}
\usepackage{cancel}             % Зачёркнутый текст
